<#
.SYNOPSIS
    Removes all <Availability> and <Additional_Attribute> elements (and
...
.EXAMPLE
    .\Remove-AvailabilityElements-Fast.ps1 -InputPath ".\feed.xml"
#>
